...
- As a core application the user chooses how they are feeling (a mood) as soon as they enter the website, and based on the mood selection a playlist is generated.
...
5. Provide a feedback mechanism to the user to communicate whether a song song or playlist is having the desired effect.
